      ...
      <Card className="shadow border-gray-200">
        <CardHeader className="bg-gray-50 border-b border-gray-200 p-3 sm:p-4 pb-3 sm:pb-4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
            ...
            {/* Redesigned Horizontal Stepper with Step Names */}
            <div className="w-full max-w-full overflow-x-auto py-2">
              <div className="flex w-full justify-between gap-1 md:gap-2">
                {[
                  { num: 1, name: "Policy & Member" },
                  { num: 2, name: "Children" },
                  { num: 3, name: "Spouse" },
                  { num: 4, name: "Extended Family" },
                  { num: 5, name: "Beneficiaries" },
                  { num: 6, name: "Payment" },
                  { num: 7, name: "Summary" },
                  { num: 8, name: "Policy Details" }
                  ...
                  >
                    <div
                      className={cn(
                        "w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-sm font-medium mb-1",
                        stepNumber === step 
